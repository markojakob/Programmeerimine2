...
namespace KooliProjekt.Controllers
{
    public class CarsController : Controller
    {
        ...
        // GET: Cars
        public async Task<IActionResult> Index(int page = 1, CarsIndexModel model = null)
        {
            model = model ?? new CarsIndexModel();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Model,CarMaker,Price,Colour,Description,KmTariff,Category")] Car car)
        {
            if (id != car.Id)
            {
                return NotFound();
